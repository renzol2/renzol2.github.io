...
export default function About() {
  return (
    <Center w="100%" minH="400px" h="90%" id="about">
      <Grid px={['5%', '15%']} templateColumns={['100%', '100%', '35% 65%']}>
        <FadingComponent>
          <Center pb={5}>
            <Image
              alt="Renzo Ledesma"
        ...
        <Center>
          <Box fontSize={['lg', '2xl']} fontWeight="light" px={5}>
            <Text>
              ...
              Science and Music. I enjoy creating things, specifically websites,
              apps, and music. Here are some technologies and things I've been
              enjoying recently:
            </Text>
            <Grid
